...
import {
    SHIPPING_ADDRESSES_COLUMN_DESCRIPTION,
    SHIPPING_ADDRESSES_COLUMN_PROPERTIES,
    SHIPPING_ADDRESSES_COLUMN_PROPERTIES_TYPE,
    pathName,
    tableName,
    endpoint
} from '../../../static/constants/shippingAddresses';
...
class BoardJsx extends React.Component {
    ...
    render() {
        const table = SHIPPING_ADDRESSES_COLUMN_DESCRIPTION;
        const tableProps = SHIPPING_ADDRESSES_COLUMN_PROPERTIES;
        const tablePropsType = SHIPPING_ADDRESSES_COLUMN_PROPERTIES_TYPE;
