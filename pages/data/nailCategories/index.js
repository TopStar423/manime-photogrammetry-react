...
import {
    NAIL_CATEGORIES_COLUMN_DESCRIPTION,
    NAIL_CATEGORIES_COLUMN_PROPERTIES,
    NAIL_CATEGORIES_COLUMN_PROPERTIES_TYPE,
    pathName,
    tableName,
    endpoint
} from '../../../static/constants/nailCategories';
...
class BoardJsx extends React.Component {
    ...
    render() {
        const table = NAIL_CATEGORIES_COLUMN_DESCRIPTION;
        const tableProps = NAIL_CATEGORIES_COLUMN_PROPERTIES;
        const tablePropsType = NAIL_CATEGORIES_COLUMN_PROPERTIES_TYPE;
