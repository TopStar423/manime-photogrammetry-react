...
import {
    ORDERS_COLUMN_DESCRIPTION,
    ORDERS_COLUMN_PROPERTIES,
    ORDERS_COLUMN_PROPERTIES_TYPE,
    pathName,
    tableName,
    endpoint
} from '../../../static/constants/orders';
...
class BoardJsx extends React.Component {
    ...
    render() {
        const table = ORDERS_COLUMN_DESCRIPTION;
        const tableProps = ORDERS_COLUMN_PROPERTIES;
        const tablePropsType = ORDERS_COLUMN_PROPERTIES_TYPE;
